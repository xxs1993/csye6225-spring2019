...
lambdaArn=$(aws lambda create-function --function-name "csye6225-lambda-function" --runtime "java8" --role $lambdaRoleArn --handler "LogEvent::handleRequest" --environment '{"Variables":{"DynamoDB_TableName":"csye6225","From_EmailAddress":"csye6225-spring2019-${S3BucketName}.me"}}' --zip-file fileb://../../../csye6225-1.0-SNAPSHOT.zip --query "FunctionArn" --output "text")
